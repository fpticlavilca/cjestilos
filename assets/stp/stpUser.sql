/*CREATE CRUD USER*/
drop procedure if exists userC;
delimiter //
    ...
    begin
		...
		insert into person(name,lastName,email,direction,phone,idCatalogStatus)values(name_param,lastName_param,email_param,direction_param,phone_param,1);
...
drop procedure if exists userU;
delimiter //
...
drop procedure if exists userD;
delimiter //
...
drop procedure if exists userCH;
delimiter //
